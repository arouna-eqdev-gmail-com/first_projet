<?php 
  include'control/db_connect.php';
    $qry = $conn->query("SELECT * FROM  list_produit where id = ".$_GET['id'])->fetch_array();
?>
<div class="container-fluid">

	<div class="card ">
        <img src="assets/imges/<?php echo $qry['imag_pro'] ?>" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title"><?php echo $qry['name'] ?></h5>
          <p class="card-text truncate"><?php echo $qry['description'] ?></p>

		  <p class="card-text truncate"><?php echo $qry['prix'] ?></p>

          <div class="form-group">
          </div>
          <div class="row">
          	<div class="col-md-2"><label class="control-label">Qté</label></div>
          ...
          <div class="text-center">
          	<button class="btn btn-outline-primary btn-sm btn-block" id="add_to_cart_modal"><i class="fa fa-cart-plus"></i> Ajouter au panier</button>
          </div>
        </div>
